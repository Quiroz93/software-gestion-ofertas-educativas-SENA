...
<head>
    ...
    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('public_content.edit')): ?>
    <style>
        .editable {
            position: relative;
            cursor: pointer;
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container">
            ...
            <!-- Logo -->
            <a href="<?php echo e(route('dashboard')); ?>" class="d-flex align-items-center me-2">
            ...
            <a class="navbar-brand text-white editable" href="#" style="font-size:1rem;" data-model="home" data-model-id="0" data-key="navbar_brand" data-type="text">
                <?php echo e(getCustomContent('home', 'navbar_brand', 'SOE | SENA')); ?>
            ...
            <div class="collapse navbar-collapse" id="navbarAuth">
                <div class="ms-auto d-flex flex-wrap gap-3 align-items-center">
                    ...
                    <ul class="navbar-nav flex-row gap-3 small">
                        <li class="nav-item">
                            <a class="nav-link text-white text-decoration-underline hover-sena editable" href="#" data-model="home" data-model-id="0" data-key="nav_link_1" data-type="text"><?php echo e(getCustomContent('home', 'nav_link_1', 'Inicio')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white text-decoration-underline hover-sena editable" href="#" data-model="home" data-model-id="0" data-key="nav_link_2" data-type="text"><?php echo e(getCustomContent('home', 'nav_link_2', 'Servicios')); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white text-decoration-underline hover-sena editable" href="#" data-model="home" data-model-id="0" data-key="nav_link_3" data-type="text"><?php echo e(getCustomContent('home', 'nav_link_3', 'Contacto')); ?></a>
                        </li>
                    </ul>

                    <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary btn-sm">
                        <i class="bi bi-box-arrow-in-right me-1"></i> Iniciar sesión
                    </a>

                    <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-success btn-sm">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="hero-card text-center">
                        ...
                        <h1 class="fw-bold mb-3 mt-5 editable" data-model="home" data-model-id="0" data-key="hero_title" data-type="text">
                            <?php echo e(getCustomContent('home', 'hero_title', 'Sistema de Ofertas Educativas SENA - CATA')); ?>

                        </h1>

                        <p class="text-muted fs-5 mb-4 editable" data-model="home" data-model-id="0" data-key="hero_subtitle" data-type="text">
                            <?php echo e(getCustomContent('home', 'hero_subtitle', 'Plataforma institucional para la administración, control y publicación de ofertas educativas del SENA - Santander.')); ?>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide mb-5">
                            ...
                            <div class="carousel-inner rounded">
                                <div class="carousel-item active">
                                    <img src="<?php echo e(getCustomContent('home', 'carousel_image_1', asset('images/oferta1.jpeg'))); ?>" class="d-block w-100 editable" alt="Imagen 1" data-model="home" data-model-id="0" data-key="carousel_image_1" data-type="image">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(getCustomContent('home', 'carousel_image_2', asset('images/oferta2.jpeg'))); ?>" class="d-block w-100 editable" alt="Imagen 2" data-model="home" data-model-id="0" data-key="carousel_image_2" data-type="image">
                                </div>
                                <div class="carousel-item">
                                    <img src="<?php echo e(getCustomContent('home', 'carousel_image_3', asset('images/oferta3.jpeg'))); ?>" class="d-block w-100 editable" alt="Imagen 3" data-model="home" data-model-id="0" data-key="carousel_image_3" data-type="image">
                                </div>
                            </div>
                        ...
                        <section class="py-5">
                            <div class="container">
                                <h2 class="text-center fw-bold mb-4 editable" data-model="home" data-model-id="0" data-key="news_title" data-type="text"><?php echo e(getCustomContent('home', 'news_title', 'Últimas Noticias')); ?></h2>
                                <div class="row">
                                    <?php if(isset($noticias) && $noticias->count() > 0): ?>
                                    <?php $__currentLoopData = $noticias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noticia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="col-md-3 mb-4">
                                        <div class="card h-100">
                                            <?php if($noticia->imagen): ?>
                                            <img src="<?php echo e(asset('storage/' . $noticia->imagen)); ?>" class="card-img-top" alt="<?php echo e($noticia->titulo); ?>">
                                            <?php endif; ?>
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo e($noticia->titulo); ?></h5>
                                                <p class="card-text"><?php echo e(Str::limit($noticia->contenido, 100)); ?></p>
                                            </div>
                                    ...
                                    <?php else: ?>
                                    <div class="col">
                                        <p class="text-center text-muted editable" data-model="home" data-model-id="0" data-key="no_news_message" data-type="text"><?php echo e(getCustomContent('home', 'no_news_message', 'No hay noticias disponibles en este momento.')); ?></p>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <section class="py-5 bg-light">
                            <div class="container">
                                <h2 class="text-center fw-bold mb-4 editable" data-model="home" data-model-id="0" data-key="offers_title" data-type="text"><?php echo e(getCustomContent('home', 'offers_title', 'Ofertas Educativas Recientes')); ?></h2>
                                <div class="row">
                                    <?php if(isset($ofertas) && $ofertas->count() > 0): ?>
                                    ...
                                    <div class="col-md-3 mb-4">
                                        <div class="card h-100">
                                            <div class="card-body">
                                                <h5 class="card-title"><?php echo e($oferta->nombre); ?></h5>
                                                <p class="card-text"><?php echo e(Str::limit($oferta->descripcion, 100)); ?></p>
                                            </div>
                                            <div class="card-footer">
                                    ...
                                    <?php else: ?>
                                    <div class="col">
                                        <p class="text-center text-muted editable" data-model="home" data-model-id="0" data-key="no_offers_message" data-type="text"><?php echo e(getCustomContent('home', 'no_offers_message', 'No hay ofertas disponibles en este momento.')); ?></p>
                                    </div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-3">
                                ...
                                <h6 class="fw-bold editable" data-model="home" data-model-id="0" data-key="feature_1_title" data-type="text"><?php echo e(getCustomContent('home', 'feature_1_title', 'Centros')); ?></h6>
                                <p class="text-muted small editable" data-model="home" data-model-id="0" data-key="feature_1_text" data-type="text"><?php echo e(getCustomContent('home', 'feature_1_text', 'Gestión de centros de formación.')); ?></p>
                            </div>

                            <div class="col-md-3">
                                <i class="bi bi-journal-bookmark feature-icon"></i>
                                <h6 class="fw-bold editable" data-model="home" data-model-id="0" data-key="feature_2_title" data-type="text"><?php echo e(getCustomContent('home', 'feature_2_title', 'Programas')); ?></h6>
                                <p class="text-muted small editable" data-model="home" data-model-id="0" data-key="feature_2_text" data-type="text"><?php echo e(getCustomContent('home', 'feature_2_text', 'Administración de programas educativos.')); ?></p>
                            </div>

                            <div class="col-md-3">
                                <i class="bi bi-mortarboard feature-icon"></i>
                                <h6 class="fw-bold editable" data-model="home" data-model-id="0" data-key="feature_3_title" data-type="text"><?php echo e(getCustomContent('home', 'feature_3_title', 'Ofertas')); ?></h6>
                                <p class="text-muted small editable" data-model="home" data-model-id="0" data-key="feature_3_text" data-type="text"><?php echo e(getCustomContent('home', 'feature_3_text', 'Control de ofertas educativas vigentes.')); ?></p>
                            </div>

                            <div class="col-md-3">
                                <i class="bi bi-newspaper feature-icon"></i>
                                <h6 class="fw-bold editable" data-model="home" data-model-id="0" data-key="feature_4_title" data-type="text"><?php echo e(getCustomContent('home', 'feature_4_title', 'Noticias')); ?></h6>
                                <p class="text-muted small editable" data-model="home" data-model-id="0" data-key="feature_4_text" data-type="text"><?php echo e(getCustomContent('home', 'feature_4_text', 'Últimas noticias y novedades.')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <footer class="bg-light py-5">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h5 class="editable" data-model="home" data-model-id="0" data-key="footer_col_1_title" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_1_title', 'Centro')); ?></h5>
                    <ul class="list-unstyled">
                        <li><a href="#" class="text-decoration-none text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_1_link_1" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_1_link_1', 'Sobre nosotros')); ?></a></li>
                        <li><a href="#" class="text-decoration-none text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_1_link_2" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_1_link_2', 'Programas')); ?></a></li>
                        <!-- more links -->
                    </ul>
                </div>
                <div class="col-md-3">
                    <h5 class="editable" data-model="home" data-model-id="0" data-key="footer_col_2_title" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_2_title', 'Servicios')); ?></h5>
                    <ul class="list-unstyled">
                        <li><a href="#" class="text-decoration-none text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_2_link_1" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_2_link_1', 'Características')); ?></a></li>
                        <li><a href="#" class="text-decoration-none text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_2_link_2" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_2_link_2', 'información')); ?></a></li>
                        <!-- more links -->
                    </ul>
                </div>
                <div class="col-md-3">
                    <h5 class="editable" data-model="home" data-model-id="0" data-key="footer_col_3_title" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_3_title', 'Recursos')); ?></h5>
                    <ul class="list-unstyled">
                        <li><a href="#" class="text-decoration-none text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_3_link_1" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_3_link_1', 'Blog')); ?></a></li>
                        <li><a href="#" class="text-decoration-none text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_3_link_2" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_3_link_2', 'Centro de ayuda')); ?></a></li>
                        <!-- more links -->
                    </ul>
                </div>
                <div class="col-md-3">
                    <h5 class="editable" data-model="home" data-model-id="0" data-key="footer_col_4_title" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_4_title', 'Contactanos')); ?></h5>
                    <p class="text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_4_line_1" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_4_line_1', 'Cra. 11 No. 13-13')); ?></p>
                    <p class="text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_4_line_2" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_4_line_2', 'Linea de atención: 018000 910270')); ?></p>
                    <p class="text-muted editable" data-model="home" data-model-id="0" data-key="footer_col_4_line_3" data-type="text"><?php echo e(getCustomContent('home', 'footer_col_4_line_3', 'Email: servicioalciudadano@sena.udu.co')); ?></p>
                </div>
            </div>
            <div class="row mt-4">
                <div class="col">
                    <p class="text-center text-muted border-top pt-3 editable" data-model="home" data-model-id="0" data-key="footer_copyright" data-type="text"><?php echo e(getCustomContent('home', 'footer_copyright', '© 2026 SENA, Centro Agroempresarial y Turístico de los Andes.')); ?></p>
                </div>
            </div>
        </div>
    </footer>
    ...
    $(function () {
        ...
        function saveTextContent() {
            ...
            fetch("<?php echo e(route('public.content.store')); ?>", {
                method: "POST",
...
<?php /**PATH C:\Users\Saave\Documents\project\SOES\SoeSoftware2\resources\views/welcome.blade.php ENDPATH**/ ?>