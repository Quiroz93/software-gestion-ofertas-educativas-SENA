...
<body>
    <div class="container">
        <nav>
            <div class="logo">
                ...
                <a href="<?php echo e(route('welcome')); ?>">SOE | SENA</a>
            </div>
            <div class="menu-items">
                ...
                <?php else: ?>
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="btn outlined">Iniciar Sesión</a>
                    <a href="<?php echo e(route('register')); ?>" class="btn">Registrarse</a>
                <?php endif; ?>
            </div>
        </nav>
        ...
        <header>
            ...
            <div class="right">
                <img src="<?php echo e(asset('images/hero-image.png')); ?>" alt="Education Illustration">
    ...
    <div class="featured">
        <div class="container">
            ...
            <div class="logos">
                <img src="<?php echo e(asset('images/airbnb-logo.svg')); ?>" alt="Logo 1">
                <img src="<?php echo e(asset('images/spotify-logo.svg')); ?>" alt="Logo 2">
                <img src="<?php echo e(asset('images/google-logo.svg')); ?>" alt="Logo 3">
                <img src="<?php echo e(asset('images/canva-logo.svg')); ?>" alt="Logo 4">
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="left">
                ...
                <div class="features-container">
                    <div class="feature">
                        <div class="icon">
                            <img src="<?php echo e(asset('images/check-icon.svg')); ?>" alt="Mission Icon">
                        </div>
                    ...
                    <div class="feature">
                        <div class="icon">
                            <img src="<?php echo e(asset('images/check-icon.svg')); ?>" alt="Flexible Learning Icon">
                        </div>
                    ...
                    <div class="feature">
                        <div class="icon">
                            <img src="<?php echo e(asset('images/check-icon.svg')); ?>" alt="Support Icon">
                        </div>
                    ...
                    <div class="feature">
                        <div class="icon">
                            <img src="<?php echo e(asset('images/check-icon.svg')); ?>" alt="Community Icon">
                        </div>
            ...
            <div class="right">
                <img src="<?php echo e(asset('images/image1.jpg')); ?>" alt="About Illustration">
            </div>
        </div>
    </section>
    ...
    <section id="services">
        <div class="container">
            ...
            <div class="services-container">
                <div class="service">
                    <img src="<?php echo e(asset('images/service1.jpg')); ?>" alt="">
                    <div class="content">
                ...
                <div class="service">
                    <img src="<?php echo e(asset('images/service2.jpg')); ?>" alt="">
                    <div class="content">
                ...
                <div class="service">
                    <img src="<?php echo e(asset('images/service3.jpg')); ?>" alt="">
                    <div class="content">
    ...
    <section id="why">
        <div class="container">
            <div class="left">
                <img src="<?php echo e(asset('images/image2.png')); ?>" alt="About Illustration">
            </div>
            <div class="right">
    ...
    <div class="container">
        <section id="blog">
            ...
            <div class="services-container">
                <div class="service">
                    <a href="#">
                        <img src="<?php echo e(asset('images/blog1.jpg')); ?>" alt="Blog Post 1">
                    </a>
                    <div class="content">
                ...
                <div class="service">
                    <a href="#">
                        <img src="<?php echo e(asset('images/blog2.jpg')); ?>" alt="Blog Post 2">
                    </a>
                    <div class="content">
                        <a href="#" class="read-more">
                ...
                <div class="service">
                    <a href="#">
                        <img src="<?php echo e(asset('images/blog3.jpg')); ?>" alt="Blog Post 3">
                    </a>
                    <div class="content">
                        <a href="#" class="read-more">
    ...
    <div class="contact" id="contact">
        <div class="container">
            <div class="heading-container">
                ...
                <a href="<?php echo e(route('register')); ?>" class="btn">Contáctanos Hoy</a>
            </div>
            <form action="#">
                <div class="group">
    ...
    <footer>
        <div class="container">
            <div class="top">
                <div class="left">
                    <a href="<?php echo e(route('welcome')); ?>" class="logo">Logo</a>
                    <h3>SOE | SENA</h3>
                ...
                <div class="right">
                    ...
                    <div class="social">
                        <div>
                            <a href="#">
                                <img src="<?php echo e(asset('images/x-logo.svg')); ?>" alt="">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('images/instagram-logo.svg')); ?>" alt="">
                            </a>
                            <a href="#">
                                <img src="<?php echo e(asset('images/dribbble-logo.svg')); ?>" alt="">
                            </a>
                        </div>
                    </div>
                </div>
...
<?php /**PATH C:\Users\Saave\Documents\project\SOES\SoeSoftware2\resources\views/public/welcome.blade.php ENDPATH**/ ?>