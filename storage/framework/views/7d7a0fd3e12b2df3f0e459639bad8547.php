...
<?php $__env->startSection('title', 'Editar Preinscrito'); ?>

<?php $__env->startSection('content_header'); ?>
<div class="d-flex justify-content-between align-items-center">
    <h1 class="m-0">
        <i class="fas fa-edit text-primary"></i>
        Editar Preinscrito: <?php echo e($presrito->nombre_completo); ?>
    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card card-outline card-primary">
                ...
                <form action="<?php echo e(route('preinscritos.update', $presrito->id)); ?>" method="POST" id="formPresrito">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="nombres" name="nombres" value="<?php echo e(old('nombres', $presrito->nombres)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="apellidos" name="apellidos" value="<?php echo e(old('apellidos', $presrito->apellidos)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $tiposDocumento; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valor => $etiqueta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($valor); ?>" <?php echo e(old('tipo_documento', $presrito->tipo_documento) == $valor ? 'selected' : ''); ?>>
                                            <?php echo e($etiqueta); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       id="numero_documento" name="numero_documento" value="<?php echo e(old('numero_documento', $presrito->numero_documento)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="celular_principal" name="celular_principal" value="<?php echo e(old('celular_principal', $presrito->celular_principal)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="celular_alternativo" name="celular_alternativo" value="<?php echo e(old('celular_alternativo', $presrito->celular_alternativo)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="correo_principal" name="correo_principal" value="<?php echo e(old('correo_principal', $presrito->correo_principal)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="correo_alternativo" name="correo_alternativo" value="<?php echo e(old('correo_alternativo', $presrito->correo_alternativo)); ?>" 
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $programas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($programa->id); ?>" <?php echo e(old('programa_id', $presrito->programa_id) == $programa->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" 
                                    ...
                                    <?php $__currentLoopData = $estados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $valor => $etiqueta): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($valor); ?>" <?php echo e(old('estado', $presrito->estado) == $valor ? 'selected' : ''); ?>>
                                            <?php echo e($etiqueta); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                          ...
                                          placeholder="Agrega comentarios o notas adicionales..."><?php echo e(old('comentarios', $presrito->comentarios)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="alert alert-light border mt-3">
                            <small class="text-muted d-block">
                                <strong>Creado:</strong> <?php echo e($presrito->created_at->format('d/m/Y H:i')); ?>

                                <?php if($presrito->createdBy): ?>
                                    por <?php echo e($presrito->createdBy->name); ?>

                                <?php endif; ?>
                            </small>
                            <small class="text-muted d-block">
                                <strong>Última actualización:</strong> <?php echo e($presrito->updated_at->format('d/m/Y H:i')); ?>

                                <?php if($presrito->updatedBy): ?>
                                    por <?php echo e($presrito->updatedBy->name); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\AdminSena\Documents\SoeSoftware2\resources\views/admin/preinscritos/edit.blade.php ENDPATH**/ ?>