    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-2">
            <div class="card card-outline card-primary">
                ...
                <form action="{{ route('preinscritos.store') }}" method="POST" id="formPresrito">
                    @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('celular_principal') is-invalid @enderror" 
                                       id="celular_principal" name="celular_principal" value="{{ old('celular_principal') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control @error('celular_alternativo') is-invalid @enderror" 
                                       id="celular_alternativo" name="celular_alternativo" value="{{ old('celular_alternativo') }}" 
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control @error('correo_principal') is-invalid @enderror" 
                                       id="correo_principal" name="correo_principal" value="{{ old('correo_principal') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="email" class="form-control @error('correo_alternativo') is-invalid @enderror" 
                                       id="correo_alternativo" name="correo_alternativo" value="{{ old('correo_alternativo') }}" 
                        ...
                        <div class="row mb-3">
                            <div class="col-12">
                                ...
                                <textarea class="form-control @error('comentarios') is-invalid @enderror" 
                                          ...
                                          placeholder="Agrega comentarios o notas adicionales...">{{ old('comentarios') }}</textarea>
                                @error('comentarios')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
