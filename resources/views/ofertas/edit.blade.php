                ...
                <form action="{{-- logica de editar oferta--}}" method="POST" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    value=" {{-- logica para mostrar el nombre de la oferta --}} "
                                    name="nombre"
                                    id="nombre"
                                    class="form-control">
                        </div>
                    ...
                    {{-- año de la Oferta --}}
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date"
                                    value=" {{-- logica para mostrar el año de la oferta --}} "
                                    name="fecha"
                                    id="fecha"
                                    class="form-control">
                        </div>
                    ...
                    {{-- fecha inicial de la Oferta --}}
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date"
                                    value=" {{-- logica para mostrar la fecha de inicio de la oferta --}} "
                                    name="fecha_inicio"
                                    id="fecha_inicio"
                                    class="form-control">
                        </div>
                    ...
                    {{-- fecha final de la Oferta --}}
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="date"
                                    value=" {{-- logica para mostrar la fecha final de la oferta --}} "
                                    name="fecha_final"
                                    id="fecha_final"
                                    class="form-control">
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <select name="estado" id="estado" class="form-control">
                                    {{-- logica para mostrar el estado seleccionado --}}
                                </select>
