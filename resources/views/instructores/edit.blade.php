...
<div class="container-fluid">
    <div class="row mb-2">
        <div class="col-sm-6">
            <h1 class="m-0">Editar instructor</h1>
        </div>
        <div class="col-sm-6">
                ...
                <form action="{{-- logica de crear instructores --}}" method="POST" class="form-horizontal">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    value=" {{-- logica para mostrar el nombre del instructor --}} "
                                    name="nombre"
                                    id="nombre"
                                    class="form-control">
                            </div>
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    value=" {{-- logica para mostrar el apellido del instructor --}} "
                                    name="apellido"
                                    id="apellido"
                                    class="form-control">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea value=" {{-- logica para mostrar el perfil del instructor --}} "
                                    name="perfil"
                                    id="perfil"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text"
                                    value=" {{-- logica para mostrar la experiencia del instructor --}} "
                                    name="experiencia"
                                    id="experiencia"
                                    class="form-control">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="email"
                                    value=" {{-- logica para mostrar el correo del instructor --}} "
                                    name="correo"
                                    id="correo"
                                    class="form-control">
                            </div>
