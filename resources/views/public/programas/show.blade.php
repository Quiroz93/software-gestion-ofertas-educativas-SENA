...
<div class="container-fluid">
    ...
    <div class="hero hero-programa hero-md">
        <div class="container">
            ...
            <div class="row align-items-center mt-3">
                <div class="col-lg-8">
                    <h1 class="hero-title fw-bold mb-3">{{ $programa->nombre }}</h1>
                ...
                <div class="col-lg-4 text-lg-end d-none d-lg-block">
                    <i class="bi bi-book-half text-white display-3 opacity-25"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container mb-5">
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <!-- Description Section -->
                <div class="card card-programa shadow-sm border-0 mb-4">
                    <div class="card-body">
            ...
            <div class="col-lg-4">
                <!-- Quick Info Card -->
                <div class="card card-programa shadow-sm border-0 mb-4 sticky-top sticky-top-offset">
                    <div class="card-body">
                        ...
                        @if($programa->nivel)
                        <div class="d-flex mb-3 pb-3 border-bottom">
                            <i class="bi bi-mortarboard text-success me-3 fs-4"></i>
                            <div>
