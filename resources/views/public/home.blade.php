...
@section('title', 'Sistema de ofertas educativas SENA-CATA')
...
@section('content')
    <nav id="navbar">
        <div class="nav-container">
            <a href="#home" class="logo-link">
                <img class="logo-svg" src="{{ asset('images/logosimbolo-SENA.svg') }}" alt="Logo SENA">
            ...
            <ul class="nav-links">
                ...
                @guest
                    <li><a href="{{ route('login') }}" class="nav-cta">Ingresar</a></li>
    ...
    <section class="hero" id="home">
        ...
        <div class="hero-container">
            ...
            <div class="hero-right {{ $slides->isEmpty() ? 'logo-only' : '' }}">
                    ...
                    <div class="hero-carousel">
                        ...
                        @else
                            <div class="carousel-slide active is-logo">
                                <img class="carousel-logo" src="{{ asset('images/logosimbolo-SENA.svg') }}" alt="Logo SENA">
                            </div>
                        @endif
                        ...
                        <div class="carousel-indicators">
                            @if($slides->isNotEmpty())
                                @foreach($slides as $slide)
                                    <span class="indicator {{ $loop->first ? 'active' : '' }}" data-slide="{{ $loop->index }}"></span>
                                @endforeach
                            @else
    ...
    <section class="collections" id="collections">
        ...
        <div class="grid" id="collectionsGrid">
            @forelse($featuredProgramas as $programa)
                @php
                    $nivel = $programa->nivelFormacion->nombre ?? 'Programa';
                    $categoria = \Illuminate\Support\Str::slug($nivel);
                @endphp
                <div class="collection-card" data-category="{{ $categoria }}">
                    <div class="collection-thumbnail">
                        <img src="{{ asset('images/hero-image.png') }}" alt="{{ $programa->nombre }}">
                    </div>
                ...
                <div class="featured-image-section">
                    <div class="featured-image-grid">
                        <div class="featured-img">
                            <img src="{{ asset('images/oferta1.jpeg') }}" alt="Oferta educativa SENA">
                        </div>
                        <div class="featured-img">
                            <img src="{{ asset('images/oferta2.jpeg') }}" alt="Formacion practica">
                        </div>
                        <div class="featured-img">
                            <img src="{{ asset('images/oferta3.jpeg') }}" alt="Aprendizaje aplicado">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="collections" id="noticias">
        ...
        <div class="grid">
            @forelse($noticias->take(3) as $noticia)
                @php
                ...
                <div class="collection-card">
                    <div class="collection-thumbnail">
                        <img src="{{ $noticiaImage }}" alt="{{ $noticia->titulo }}">
                    </div>
                    <div class="card-content">
                        <span class="card-badge">Noticia</span>
                        <h3 class="card-title">{{ $noticia->titulo_medio }}</h3>
                        <p class="card-subtitle">
                            {{ $noticia->created_at?->format('d/m/Y') ?? 'Fecha por confirmar' }}
                        </p>
                        <a class="card-price" href="{{ route('public.ultimaNoticias.show', ['ultimaNoticia' => $noticia->id]) }}">Leer noticia</a>
                    </div>
                </div>
            @empty
                <div class="collection-card">
                    <div class="collection-thumbnail">
                        <img src="{{ asset('images/oferta1.jpeg') }}" alt="Noticias SENA">
                    </div>
                    <div class="card-content">
                        ...
                        <a class="card-price" href="{{ route('public.ultimaNoticias.index') }}">Ver todas las noticias</a>
                    </div>
                </div>
            @endforelse
        </div>
    ...
    <section class="collections" id="nosotros">
        ...
        <div class="grid">
            <div class="collection-card">
                <div class="collection-thumbnail">
                    <img src="{{ asset('images/hero-image.png') }}" alt="Mision institucional">
                </div>
                <div class="card-content">
                    ...
                    <a class="card-price" href="{{ route('public.centrosFormacion.index') }}">Conoce el centro</a>
                </div>
            </div>

            <div class="collection-card">
                <div class="collection-thumbnail">
                    <img src="{{ asset('images/oferta2.jpeg') }}" alt="Vision institucional">
                </div>
                <div class="card-content">
                    ...
                    <a class="card-price" href="{{ route('public.redesDeConocimiento.index') }}">Ver redes</a>
                </div>
            </div>

            <div class="collection-card">
                <div class="collection-thumbnail">
                    <img src="{{ asset('images/oferta1.jpeg') }}" alt="Bienestar y acompanamiento">
                </div>
                <div class="card-content">
                    ...
                    <a class="card-price" href="{{ route('public.instructoresDeFormacion.index') }}">Conoce el equipo</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="collections" id="eventos">
        ...
        <div class="grid">
            @forelse($eventos as $evento)
                ...
                <div class="collection-card">
                    <div class="collection-thumbnail">
                        <img src="{{ $imagenUrl }}" alt="{{ $imagenAlt ?? $evento->nombre }}" title="{{ $imagenTitle ?? $evento->nombre }}">
                    </div>
                    <div class="card-content">
                        <span class="card-badge">Agenda</span>
                        <h3 class="card-title">{{ $evento->nombre }}</h3>
                        <p class="card-subtitle">{{ $rangoFechas }}</p>
                        <a class="card-price" href="{{ route('public.ofertasEducativas.show', $evento) }}">Ver detalles</a>
                    </div>
                </div>
            @empty
                <div class="collection-card">
                    <div class="collection-thumbnail">
                        <img src="{{ asset('images/oferta2.jpeg') }}" alt="Eventos SENA">
                    </div>
                    <div class="card-content">
                        ...
                        <a class="card-price" href="{{ route('public.ofertasEducativas.index') }}">Ver ofertas</a>
                    </div>
                </div>
            @endforelse
        </div>
