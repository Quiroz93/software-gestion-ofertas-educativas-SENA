...
<div class="container-fluid">
    <!-- Hero Section -->
    <div class="bg-info text-white py-5 mb-5 rounded-bottom-lg">
        <div class="container">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-4 text-center">
                    <i class="bi bi-mortarboard display-3 text-light opacity-50"></i>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fw-bold mb-2">{{ $nivel->nombre }}</h5>
    ...
    <div class="container mb-5">
        <div class="bg-info text-white rounded-lg p-5 text-center">
