...
<div class="container-fluid">
    ...
    <div class="container mb-5 py-4" id="redes">
        <h3 class="h3 fw-bold text-center mb-5" style="color: var(--sena-blue-dark);">Nuestras Redes de Conocimiento</h3>
                        ...
                        <div class="card-body p-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    <h5 class="fw-bold mb-2" style="color: var(--sena-blue-dark);">{{ $red->nombre }}</h5>
